...
const Mint = () => {
  const [preSupply, setPreSupply] = useState(0);
  ...
  const getOgSalePrice = async () => {
    const ogPrice = await mintContract.methods.publicPrice().call();
    ...
    <div className="h-screen">
      ...
      <div className="flex justify-center items-center flex-col space-y-5 mt-4">
        <div className="text-white border rounded-xl w-1/2 mx-auto flex flex-col p-4 space-y-3 border-blue-460 bg-blue-860">
          <div className="text-2xl text-center font-bold">Minted 0/{preSupply} Supply</div>
        ...
        <div className="text-white border rounded-xl w-1/2 mx-auto flex flex-col p-4 space-y-3 border-blue-460 bg-blue-860">
          <div className="text-2xl text-center font-bold">Minted 0/{pubSupply} Supply</div>
        ...
        <div className="text-white border rounded-xl w-1/2 mx-auto flex flex-col p-4 space-y-3 border-blue-460 bg-blue-860">
          <div className="text-2xl text-center font-bold">Minted 0/{ogSupply} Supply</div>
          ...
          <div className="w-72 mx-auto flex justify-center"><WalletButton price={ogSalePrice} mintType={3} amount={Number(amount3)}/> </div>
        </div>
      </div>
    </div>
  );
